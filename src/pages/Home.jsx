    ...
    <>
      ...
      <div className="h-full w-full bg-[#fefae0]">
        ...
        <div className="page1 w-full h-screen px-4">
          ...
          <div className="hero1 w-full h-[82%]">
              ...
              <div className="mam-name h-full w-full absolute z-[1]">
                <div className="cont w-3/4 h-3/4">
                  ...
                  <div className="main-title w-[80%] h-[50%] flex absolute left-[15%] bottom-25">
                    <h1 className='text-[#847B1A] font-serif uppercase text-[10em] text-center'>Diksha Mam</h1>
                  </div>
                </div>
              </div>
            ...
            <div className="hero-inner w-full h-full flex flex-col lg:flex-row px-4 lg:px-10">
              <div className="hero-left w-full lg:w-1/2 p-6 border rounded-3xl">
                <div className="text-area w-full h-full p-4">
                  <h1 className='name text-5xl font-mono text-[#958c23] mt-10 font-bold'>Diksha Mam</h1>
                  <p className="good-para text-black font-mono mt-10">
                    There are people who speak, and then there are those whose presence speaks louder than any words. She belonged to the second kind. A quiet storm — playful yet composed, unpredictable yet comforting. She understood things before they were spoken, felt what most would miss, and cared in ways that didn’t demand attention. With her, everything felt a little more real, a little less heavy. She wasn’t just part of someone’s story — she was the unsaid chapter that lingered long after the pages were turned.
                  </p>
                  <button className='about-us text-black font-semibold mt-10 px-10 py-2 rounded-full cursor-pointer border border-[#958c23]'>
                    <NavLink to='/about' className={({ isActive }) => isActive ? "active-link" : ""}> <h1 className='text-2xl  cursor-pointer'>About her</h1></NavLink>
        ...
        <div className="page3 Illutrations w-full h-screen py-5 relative">
          <div className="spring-flowers1 w-[50%] h-100 bg-cover bg-center absolute z-[10] left-0" style={{ backgroundImage: "url('/Videos/AnimationFl.gif')" }}></div>
        ...
        <div className="page4 w-full h-[140vh] mt-20 relative bg-no-repeat bg-cover">
          ...
          <div className="slider-heading w-full h-30 bg-gradient-to-r from-pink-300 via-yellow-300 to-orange-200 mt-10 flex items-center justify-center py-10 tracking-widest">
            <h1 className='text-center text-[#847B1A] uppercase text-8xl font-serif'>Beauty</h1>
          </div>
          ...
          <div ref={boxRef} className="layout-area w-full h-screen flex justify-center items-center relative">
            <div className="grid grid-cols-2 mt-4 grid-rows-2 gap-5 p-10 z-10">
              <motion.div drag dragConstraints={boxRef} style={{ backgroundImage: "url('/madam/WA2.jpg')" }} className="drag-img object-cover bg-center bg-cover w-75 h-75 border cursor-grab rounded-xl flex justify-center items-center shadow-md bg-white" />
              <motion.div drag dragConstraints={boxRef} style={{ backgroundImage: "url('/madam/Sawri2.png')" }} className="drag-img object-cover bg-center bg-cover w-75 h-75 border rounded-xl flex justify-center items-center shadow-md bg-white cursor-grab" />
              <motion.div drag dragConstraints={boxRef} style={{ backgroundImage: "url('/madam/Face3.jpg')" }} className="drag-img object-cover bg-center bg-cover w-75 h-75 border rounded-xl flex justify-center items-center shadow-md bg-white cursor-grab" />
              <motion.div drag dragConstraints={boxRef} style={{ backgroundImage: "url('/madam/Car2.jpg')" }} className="drag-img object-cover bg-center bg-cover w-75 h-75 border rounded-xl flex justify-center items-center shadow-md bg-white cursor-grab" />
            </div>
          </div>
        </div>
        ...
        <div className="page5 w-full h-screen bg-[#fefae0] shadow-lg bg-cover bg-center bg-no-repeat relative" style={{ backgroundImage: "url('/backgrounds/Bg2.jpg')" }}>
          <div className="slider-heading2 w-full h-25 bg-gradient-to-r from-pink-300 via-yellow-300 to-orange-200 flex items-center justify-center py-10 tracking-widest">
            <h1 className='text-center text-[#847B1A] uppercase text-8xl font-serif'>Shiny</h1>
          </div>

          <div className="Spring-flowers2 w-[50%] h-100 bg-cover bg-center" style={{ backgroundImage: "url('/Videos/AnimationFl.gif')" }}></div>

          <div className="image-area w-[70%] h-[65%] rounded-4xl absolute left-[17%] top-[20%] z-[100] bg-cover bg-center" style={{ backgroundImage: "url('/madam/Shadi Ghar2.jpg')" }}></div>
          ...
          <div className="last w-[50%] h-15 absolute bottom-5 left-[25%] flex justify-center items-center end-msg">
            {"Bss Ab Ruk Jao..".split("").map((char, idx) => (
              <span key={idx} className="end-msg1 inline-block text-4xl font-bold text-center font-mono text-[#847B1A]">
                {char === " " ? "\u00A0" : char}
              </span>
            ))}
          </div>
